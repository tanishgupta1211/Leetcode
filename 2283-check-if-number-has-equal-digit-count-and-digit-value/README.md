<h2><a href="https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value/?envType=problem-list-v2&envId=dw6iitxr">2377. Check if Number Has Equal Digit Count and Digit Value</a></h2><h3>Easy</h3><hr><p>You are given a <strong>0-indexed</strong> string <code>num</code> of length <code>n</code> consisting of digits.</p>
